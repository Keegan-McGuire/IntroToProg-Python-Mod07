...
#   KMcGuire, 8/25/25, Added Data Classes
# ------------------------------------------------------------------------------------------ #
import json
...
class Person:
    """
    A class that representing person data.
    ...
    ChangeLog:
    -KMcGuire, 8.26.25, Created Class
    """
...
class Student(Person):
    ...
    def course_name(self, value: str):
        if not isinstance(value, str):
            raise ValueError("Course name should be text.")
        self.__course_name = value.strip()
